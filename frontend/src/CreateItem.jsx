...
const CreateItemScreen = () => {
  ...
  const CATEGORY_SUBCATEGORIES = {
     technology: [ { value: "computers", label: "Ordenadores" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
     sports: [ { value: "cycling", label: "Ciclismo" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
     diy: [ { value: "electric_tools", label: "Herramientas eléctricas" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
     clothing: [ { value: "summer_clothing", label: "Ropa de verano" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
     furniture_and_logistics: [ { value: "home_furniture", label: "Muebles de hogar" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
     entertainment: [ { value: "videogames", label: "Videojuegos" }, /* ... resto ... */ { value: "none", label: "Ninguno" }, ],
  };
