...
const AdminTicketsDashboard = () => {
  ...
  const [filteredTickets, setFilteredTicketsts] = useState([]);
        ...
        <Paper elevation={3} sx={{ p: 4, mb: 4, borderRadius: 2 }}>
          ...
          {loading ? (
            ...
            <Alert severity="info" sx={{ mb: 4 }}>
              {reports.length === 0 ? 'No hay incidencias que mostrar' : 'No se encontraron incidencias que coincidan con los filtros aplicados'}
            </Alert>
          ) : (
