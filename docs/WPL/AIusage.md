...
| 22-05-2025 | v3.0    | Marco Padilla Gómez | Creación del documento base para el WPL|
---
...
### 2.4. Generación de recursos para las redes sociales

En esta fase final del proyecto hemos usado la IA para generar recursos que usariamos en las diferentes redes sociales, como por ejemplo para tener a nuestra mascota Don Ramon haciendo diferentes acciones.
...
| ID   | Uso (Descripción)       | Nombre del Miembro | Fecha       | Enlace al Chat |
|------|-------------------------|--------------------|------------|---------------|
| 026  | Ideas para el tiktok de pasa palabra   | Marco Padilla Gómez    | 20/05/2025 | [Ver chat](https://chatgpt.com/share/682ee9af-f34c-8012-9827-ad1016763cf1) |
...
| 026 | Ideas para el pasapalabra | Sí | 30min |
...
Aplicando la fórmula, el porcentaje medio de alucinaciones es: 15.6%

### Conclusión

El análisis muestra que el porcentaje medio de alucinaciones de la IA en este conjunto de datos es aproximadamente **15.6%%**. 

Como se puede ver, el porcentaje sigue en la linea del anterior entregable aunque con menos usos, esto se debe a que bastantes de estos usos son generacion de imagenes y suelen tener mas fallos de lo normal.
